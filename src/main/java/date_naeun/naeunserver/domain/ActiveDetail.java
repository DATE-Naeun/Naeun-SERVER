...
public class ActiveDetail {
    ...
    @Builder
    public ActiveDetail(String description, Double weight, Double d, Double o, Double s, Double r, Double p, Double n, Double t, Double w, Double whitening, Double trouble) {
